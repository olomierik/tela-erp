...
import {
  Mail, Lock, ArrowRight, Wand2, ArrowLeft, Eye, EyeOff,
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 flex">
      ...
      <div className="hidden lg:flex lg:w-[45%] items-center justify-center p-12 relative overflow-hidden bg-gradient-to-br from-primary/5 via-accent/5 to-transparent">
        ...
        <motion.div
          className="absolute top-1/4 left-1/4 w-80 h-80 rounded-full bg-primary/15 blur-[120px]"
          animate={{ x: [0, 40, 0], y: [0, -30, 0], scale: [1, 1.2, 1] }}
          transition={{ duration: 8, repeat: Infinity, ease: 'easeInOut' }}
        />
        <motion.div
          className="absolute bottom-1/4 right-1/4 w-96 h-96 rounded-full bg-accent/15 blur-[120px]"
        ...
        <div className="relative z-10 text-center max-w-md">
          <motion.img
            src={telaLogo}
            alt="TELA-ERP"
            className="w-48 h-48 object-contain mx-auto mb-8 drop-shadow-[0_20px_60px_rgba(34,197,94,0.25)]"
            animate={{ y: [0, -10, 0] }}
            transition={{ duration: 4, repeat: Infinity, ease: 'easeInOut' }}
          />

          <motion.h1
            className="text-4xl font-extrabold mb-3 bg-gradient-to-r from-primary via-accent to-primary bg-[length:200%_auto] bg-clip-text text-transparent"
          ...
          <p className="text-muted-foreground text-base leading-relaxed">
            ...
            <br />
            <span className="text-primary font-semibold">built for African enterprises.</span>
          </p>
          ...
          >
            {['Multi-Store', 'Real-Time', 'Offline-First', 'Accounting'].map((tag, i) => (
              <motion.span
                key={tag}
          ...
          <div className="rounded-2xl border border-border/50 bg-card/80 backdrop-blur-sm shadow-xl p-6 sm:p-8">
            ...
            <div className="flex items-center gap-3 my-5">
              ...
              <span className="text-xs text-muted-foreground font-medium">
                {magicLinkMode ? 'or use magic link' : 'or sign in with email'}
              </span>
              <div className="flex-1 h-px bg-border" />
            </div>
              ...
              >
                {loading ? (
                  <span className="flex items-center gap-2">
                    ...
                    {magicLinkMode ? 'Sending...' : 'Signing in...'}
                  </span>
                ) : (
                  <>
